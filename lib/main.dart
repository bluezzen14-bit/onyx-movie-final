        ...
        return ListView(
          ...
          children: [
            ...
            section(
                ...
                "Animations",
                list
                  .where((m) => m['category'] == 'Animation')
                  .toList()),
            section(
                context,
                "Indian Movies",
                list
                  .where((m) => m['category'] == 'Indian')
                  .toList()),
          ],
        );
      },
      ...
      body: ListView(
        ...
        children: [
          ...
          Glass(
            child: ListTile(
              title: const Text(
                  "Download to Gallery / ONYX Folder",
                  style:
  ...
  Future<void> checkVersion() async {
    try {
      final res = await http.get(Uri.parse(
          "https://raw.githubusercontent.com/bluezzer/onyx-movie-final/main/version.json"));
          ...
          if (mounted) {
            showDialog(
              ...
              builder: (_) => AlertDialog(
                ...
                title: Text("New Update $latestVer Available!",
                    style: const TextStyle(color: skyBlue)),
                ...
                actions: [
                  ...
                  ElevatedButton(
                    style: ElevatedButton.styleFrom(
                        ...
                        foregroundColor: Colors.black),
                    onPressed: () async {
                      final uri = Uri.parse(apkUrl.isEmpty
    ...
    return ListView(
      ...
      children: [
        FutureBuilder<SharedPreferences>(
          ...
          builder: (c, s) {
            final email =
                s.data?.getString('user')?? "guest@onyx.com";
            return Glass(
              child: ListTile(
                ...
                subtitle: const Text("ONYX Member",
                    style:
                        TextStyle(color: skyBlue, fontSize: 10)),
              ),
            );
          },
        ),
          ...
          child: Column(
            children: [
              ListTile(
                ...
                subtitle: Text(
                    latestVer == ""
                      ? "Current v$appVer - Checking..."
                        : (latestVer == appVer
                          ? "Current v$appVer - Latest"
                            : "$whatsNew\nTap to update"),
                    style: const TextStyle(
                        color: Colors.white38, fontSize: 10)),
                trailing: const Icon(
              ...
              const ListTile(
                title: Text("Security - 6 Digit Passcode",
                    style:
                        TextStyle(color: Colors.white, fontSize: 13)),
                trailing:
                    Icon(Icons.lock_rounded, color: skyBlue),
              ),
              const ListTile(
              ...
              const ListTile(
                title: Text("Face ID",
                    style:
                        TextStyle(color: Colors.white, fontSize: 13)),
                trailing:
                    Icon(Icons.face_rounded, color: skyBlue),
              ),
            ],
          ),
        ),
          ...
          child: Column(
            children: [
              ...
              ListTile(
                ...
                onTap: () async {
                  final uri = Uri.parse(
                      "mailto:mugabibenjamin14@gmail.com");
                  if (await canLaunchUrl(uri)) {
                    await launchUrl(uri);
                  }
                },
  ...
  upload() async {
    ...
    if (mounted) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text(
              "Uploaded! User panel will see it instantly"),
        ),
      );
    }
  }
