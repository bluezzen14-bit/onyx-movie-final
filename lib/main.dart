              ...
              GestureDetector(
                onTap: (){
                  Navigator.push(
                    ...
                    MaterialPageRoute(
                      builder: (_){
                        return AdminMainNav(email: email);
                      }
                    )
                  );
                },
              ...
              child: SingleChildScrollView(
                child: Column(
                  ...
                  children: [
                    ...
                    SizedBox(height:12),
                    Text("VJs (Uploaded in Admin)", style: TextStyle(color: Colors.white54)),
                    Wrap(
                      spacing:8,
                      children: vjSet.map((vj){
                        return ChoiceChip(
                          label: Text(vj),
                          selected: selectedVJ==vj,
                          onSelected: (v){
                            setState(()=>selectedVJ=v?vj:"");
                            setS(()=>{});
                          }
                        );
                      }).toList()
                    ...
                    SizedBox(height:12),
                    Text("Genres", style: TextStyle(color: Colors.white54)),
                    Wrap(
                      spacing:8,
                      children: genreSet.map((g){
                        return ChoiceChip(
                          label: Text(g),
                          selected: selectedGenre==g,
                          onSelected: (v){
                            setState(()=>selectedGenre=v?g:"");
                            setS(()=>{});
                          }
                        );
                      }).toList()
                    ...
                    SizedBox(height:12),
                    Text("Categories", style: TextStyle(color: Colors.white54)),
                    Wrap(
                      spacing:8,
                    ...
                    SizedBox(
                      ...
                      child: ElevatedButton(
                        ...
                        child: Text("Apply Filter - Show Selection")
                      )
                    ),
                  ]
                )
          ...
          GestureDetector(
            onTap: (){
              Navigator.push(
                ...
                MaterialPageRoute(
                  builder: (_){
                    return SeeMorePage(title:title, movies:list);
                  }
                )
              );
            },
    ...
    return GestureDetector(
      onTap: (){
        Navigator.push(
          ...
          MaterialPageRoute(
            builder: (_){
              return DetailPage(data:m,id:id);
            }
          )
        );
      },
              ...
              child: Container(
                ...
                child: ClipRRect(
                  ...
                  child: poster.toString().length>100
                   ? Image.memory(
                        base64Decode(poster.toString().split(',').last),
                        fit: BoxFit.cover,
                        width: double.infinity
                      )
        ...
        children: [
              ...
              children: [
                ...
                LiquidGlass(
                  ...
                  child: Container(
                    ...
                    child: Stack(
                      children:[
                        Center(child: Icon(Icons.notifications_none,color:Colors.white54)),
                        Positioned(
                          top:8,right:8,
                          child: Container(
                            width:8,height:8,
                ...
                LiquidGlass(
                  ...
                  child: Container(
                    height:50,width:50,
                    child: Center(child: Icon(Icons.download,color:Colors.white54))
                  )
                ),
              ]
            )
          ...
          Expanded(
            child: StreamBuilder(
              ...
              builder: (c,snap){
                if(!snap.hasData){
                  return IPhoneLoader(size:22, text:"Loading Home...");
                }
                List<MapEntry> all=[];
                ...
                List<MapEntry> filtered=all.where((e){
                  ...
                  bool ok=true;
                  if(selectedVJ.isNotEmpty){
                    ok=ok&&vj.contains(selectedVJ.toLowerCase());
                  }
                  if(selectedGenre.isNotEmpty){
                    ok=ok&&genre.contains(selectedGenre.toLowerCase());
                  }
                  if(selectedCategory.isNotEmpty){
                    ok=ok&&cat.contains(selectedCategory.toLowerCase());
                  }
                  return ok;
                }).toList();
                List<MapEntry> bannerList=filtered.take(7).toList();
                List<MapEntry> latestMovies=filtered.where((e){
                  final cat=(Map<String,dynamic>.from(e.value as Map)['category']??'').toString().toLowerCase();
                  return!cat.contains('series');
                }).toList();
                List<MapEntry> latestSeries=filtered.where((e){
                  final cat=(Map<String,dynamic>.from(e.value as Map)['category']??'').toString().toLowerCase();
                  return cat.contains('series');
                }).toList();
                List<MapEntry> trending=filtered.where((e){
                  final m=Map<String,dynamic>.from(e.value as Map);
                  return (m['isTrending']==true);
                }).toList();
                if(trending.isEmpty){
                  trending=filtered.take(10).toList();
                }
                List<MapEntry> animations=filtered.where((e){
                  final cat=(Map<String,dynamic>.from(e.value as Map)['category']??'').toString().toLowerCase();
                  final genre=(Map<String,dynamic>.from(e.value as Map)['genre']??'').toString().toLowerCase();
                  return cat.contains('animation')||genre.contains('animation');
                }).toList();
                List<MapEntry> indian=filtered.where((e){
                  final cat=(Map<String,dynamic>.from(e.value as Map)['category']??'').toString().toLowerCase();
                  final genre=(Map<String,dynamic>.from(e.value as Map)['genre']??'').toString().toLowerCase();
                  return cat.contains('indian')||genre.contains('indian');
                }).toList();
                    ...
                    children: [
                      Container(
                        ...
                        child: bannerList.isEmpty
                         ? Container(
                              ...
                              child: Center(
                                child: IPhoneLoader(size:24, text:"Banner 7 Latest - Loading")
                              )
                            )
                          : PageView.builder(
                      ...
                      Row(
                        ...
                        children: List.generate(
                          bannerList.length>7?7:bannerList.length,
                          (i){
                            return Container(
                              width:6,
                              height:6,
                              ...
                              decoration: BoxDecoration(
                                ...
                                color: bannerIndex==i? Colors.white : Colors.white24
                              )
                            );
                          }
                        )
                      ...
                      SizedBox(
                        ...
                        child: ListView.builder(
                          ...
                          padding: EdgeInsets.symmetric(horizontal:12),
                          itemCount: latestMovies.isEmpty?3:latestMovies.length,
                          itemBuilder: (c,i){
                            if(latestMovies.isEmpty){
                              return LiquidGlass(
                                ...
                                child: Container(
                                  width:100,
                                  margin: EdgeInsets.only(right:10),
                                  child: IPhoneLoader(size:16)
                                )
                              );
                            }
                            final m=Map<String,dynamic>.from(latestMovies[i].value as Map);
                            return moviePosterCard(m, latestMovies[i].key);
                          }
                        )
                      ),
                      ...
                      SizedBox(
                        ...
                        child: ListView.builder(
                          scrollDirection: Axis.horizontal,
                          padding: EdgeInsets.symmetric(horizontal:12),
                          itemCount: latestSeries.isEmpty?1:latestSeries.length,
                          itemBuilder: (c,i){
                            if(latestSeries.isEmpty){
                              return Padding(
                                padding: EdgeInsets.all(12),
                                child: Text(
                                  "No Series Yet - Upload in Admin",
                                  style: TextStyle(color: Colors.white54)
                                )
                              );
                            }
                            final m=Map<String,dynamic>.from(latestSeries[i].value as Map);
                            return moviePosterCard(m, latestSeries[i].key);
                          }
                        )
                      ),
                      ...
                      SizedBox(
                        ...
                        child: ListView.builder(
                          ...
                          itemBuilder: (c,i){
                            final m=Map<String,dynamic>.from(trending[i].value as Map);
                            return moviePosterCard(m, trending[i].key);
                          }
                        )
                      ),
                        ...
                        child: ListView.builder(
                          ...
                          itemBuilder: (c,i){
                            if(animations.isEmpty){
                              return Padding(
                                padding: EdgeInsets.all(12),
                                child: Text("No Animations Yet", style: TextStyle(color: Colors.white54))
                              );
                            }
                            final m=Map<String,dynamic>.from(animations[i].value as Map);
                            return moviePosterCard(m, animations[i].key);
                          }
                        )
                      ),
                      ...
                      SizedBox(
                        ...
                        child: ListView.builder(
                          scrollDirection: Axis.horizontal,
                          padding: EdgeInsets.symmetric(horizontal:12),
                          itemCount: indian.isEmpty?1:indian.length,
                          itemBuilder: (c,i){
                            if(indian.isEmpty){
                              return Padding(
                                padding: EdgeInsets.all(12),
                                child: Text("No Indian Movies Yet", style: TextStyle(color: Colors.white54))
                              );
                            }
                            final m=Map<String,dynamic>.from(indian[i].value as Map);
                            return moviePosterCard(m, indian[i].key);
                          }
                        )
                      ),
                      SizedBox(height:80),
...
class SeeMorePage extends StatelessWidget{
  ...
  Widget build(BuildContext context){
    return Scaffold(
      backgroundColor: Color(0xFF020617),
      appBar: AppBar(backgroundColor: Color(0xFF020617), title: Text(title)),
      body: GridView.builder(
        ...
        itemBuilder: (c,i){
          final m=Map<String,dynamic>.from(movies[i].value as Map);
          final poster=m['posterBase64']??'';
          final vj=m['vj']??'';
          return GestureDetector(
            onTap: (){
              Navigator.push(
                ...
                MaterialPageRoute(
                  builder: (_){
                    return DetailPage(data:m,id:movies[i].key);
                  }
                )
              );
            },
                ...
                if(vj.toString().isNotEmpty)
                  Positioned(
                    ...
                    child: Container(
                      ...
                      child: Text(vj.toString(), style: TextStyle(color: Colors.white, fontSize: 8))
                    )
                  )
              ]
            )
        ...
        children: [
          ...
          Expanded(
            child: StreamBuilder(
              ...
              builder: (c,snap){
                if(!snap.hasData){
                  return IPhoneLoader(size:22, text:"Loading Movies...");
                }
                if(snap.data!.snapshot.value==null){
                ...
                return GridView.builder(
                  ...
                  itemBuilder: (c,i){
                    ...
                    if((m['category']??'').toString().toLowerCase().contains('series')){
                      return SizedBox();
                    }
                    final poster=m['posterBase64']??'';
                    final vj=m['vj']??'';
                    return GestureDetector(
                      onTap: (){
                        Navigator.push(
                          ...
                          MaterialPageRoute(
                            builder: (_){
                              return DetailPage(data:m,id:list[i].key);
                            }
                          )
                        );
                      },
                    ...
                    return GestureDetector(
                      onTap: (){
                        Navigator.push(
                          ...
                          MaterialPageRoute(
                            builder: (_){
                              return DetailPage(data:m,id:seriesList[i].key);
                            }
                          )
                        );
                      },
...
class DetailPageState extends State<DetailPage>{
  ...
  Widget build(BuildContext context){
    ...
    return Scaffold(
      backgroundColor: Color(0xFF020617),
      appBar: AppBar(backgroundColor: Color(0xFF020617), title: Text(widget.data['title']??'')),
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
                ...
                child: Center(
                  child: Column(
                    ...
                    children:[
                      ...
                      Text("Best Player - Tap to Play", style: TextStyle(color: Colors.white70)),
                      Text("$vj • $genre • $year", style: TextStyle(color: Colors.white54, fontSize:12))
                    ]
                  )
                )
              )
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      "VJ: $vj • Genre: $genre • Year: $year • Date: ${DateTime.fromMillisecondsSinceEpoch(widget.data['timestamp']??0).toString().substring(0,10)}",
                      style: TextStyle(color: Colors.white54, fontSize:11)
                    ),
                    SizedBox(height:8),
                    Row(
                      children:[
                        ElevatedButton.icon(
                          ...
                          label: Text("Download to Gallery")
                        ),
                        SizedBox(width:8),
                        ElevatedButton.icon(
                          onPressed: () async {
                            await Share.share("Watch ${widget.data['title']} on ONYX MOVIES");
                          },
            ...
            SizedBox(height:12),
            Text("Casts (5 max) - From Admin", style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
            SizedBox(height:8),
            casts.isEmpty
             ? Text("No casts", style: TextStyle(color: Colors.white54))
              : SizedBox(
                  height: 100,
                  child: ListView.builder(
                    scrollDirection: Axis.horizontal,
                        ...
                        child: Column(
                          children:[
                            LiquidGlass(
                              ...
                              child: CircleAvatar(
                                radius:25,
                                backgroundImage: img.toString().length>100
                                 ? MemoryImage(base64Decode(img.toString().split(',').last))
                                  : null,
                                child: img.toString().length<100? Icon(Icons.person) : null
                              )
                            ),
                            Text(cast['realName']??'', maxLines:1, style: TextStyle(color: Colors.white, fontSize:10)),
                            Text(cast['actedName']??'', maxLines:1, style: TextStyle(color: Colors.white54, fontSize:8))
                          ]
                        )
                      );
                    }
            ...
            LiquidGlass(
              child: Padding(
                padding: EdgeInsets.all(12),
                child: Text(desc, style: TextStyle(color: Colors.white70))
              )
            ),
          ]
        )
                ...
                children: [
                  ...
                  Expanded(
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children:[
                        Text("OnyxMovies Folder: /Download/OnyxMovies", style: TextStyle(color: Colors.white, fontSize:11)),
                        LinearProgressIndicator(value:0.2, color: Colors.white54),
                        Text("Shows download progress by size", style: TextStyle(color: Colors.white38, fontSize:10))
                      ]
                    )
                  )
                ]
              ...
              children:[
                Center(
                  child: Column(
                    mainAxisAlignment: MainAxisAlignment.center,
                    children:[
                      IPhoneLoader(size:22),
                      SizedBox(height:10),
                      Text(
                        "Shows size based progress\nEx: 250MB / 1.2GB - 20%",
                        textAlign: TextAlign.center,
                        style: TextStyle(color: Colors.white54, fontSize:11)
                      )
                    ]
                ...
                downloadedList.isEmpty
                 ? Center(
                      child: Text(
                        "No downloaded - Saved to Gallery /OnyxMovies",
                        style: TextStyle(color: Colors.white54)
                      )
                    )
                  : ListView.builder(
                      ...
                      itemBuilder: (c,i){
                        final m=downloadedList[i];
                        return LiquidGlass(
                          child: ListTile(
                            title: Text(m['title']??'', style: TextStyle(color: Colors.white)),
                            subtitle: Text(
                              "Saved to /Download/OnyxMovies/${m['title']}.mp4 • ${m['size']??''}",
                              style: TextStyle(color: Colors.white54, fontSize:10)
                            ),
...
class ProfileTabState extends State<ProfileTab>{
  ...
  loadAll() async {
    ...
    if(av!=null){
      setState(()=>avatarBytes=base64Decode(av));
    }
    setState((){
  ...
  Future<void> autoUpdate() async {
    try{
      ...
      final request=await http.Client().send(
        http.Request('GET', Uri.parse("https://github.com/bluezzer/onyx-movie-final/releases/latest/download/app-release.apk"))
      );
    ...
    showDialog(
      ...
      builder: (_){
        return AlertDialog(
          ...
          title: Text("Set 6-digit Passcode", style: TextStyle(color: Colors.white)),
          content: TextField(
            controller: ctrl,
            keyboardType: TextInputType.number,
            maxLength:6,
            style: TextStyle(color: Colors.white),
            decoration: InputDecoration(hintText:"Enter 6 digits")
          ),
          actions:[
            TextButton(
              onPressed: () async {
                final p=await SharedPreferences.getInstance();
                await p.setString('passcode', ctrl.text);
                setState(()=>passcode=ctrl.text);
                Navigator.pop(context);
              },
              child: Text("Save")
            )
        ...
        children:[
            ...
            child: GestureDetector(
              ...
              child: LiquidGlass(
                ...
                child: CircleAvatar(
                  ...
                  child: avatarBytes==null?Icon(Icons.person,size:40):null
                )
              )
            )
          ),
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  Row(
                    children:[
                      Icon(Icons.system_update,color:Colors.white70,size:20),
                      SizedBox(width:8),
                      Text(
                        "New Release Update",
                        style:TextStyle(color:Colors.white,fontWeight:FontWeight.bold)
                  ...
                  SizedBox(
                    ...
                    child: ElevatedButton(
                      ...
                      child: Text(
                        isDownloading?"Downloading...":"Check New Version",
                        style: TextStyle(color: Colors.white)
                      )
                    )
                  )
          ...
          LiquidGlass(
            child: SwitchListTile(
              title: Text("Download to Gallery - /OnyxMovies", style: TextStyle(color: Colors.white, fontSize:12)),
              subtitle: Text(
                downloadToGallery? "On - Saves to Gallery" : "Off - Stay in app & play offline",
                style: TextStyle(color: Colors.white38, fontSize:10)
              ),
              value: downloadToGallery,
              onChanged: (v) async {
                final p=await SharedPreferences.getInstance();
                await p.setBool('download_to_gallery',v);
                setState(()=>downloadToGallery=v);
              }
            )
          ),
          LiquidGlass(
            child: SwitchListTile(
              title: Text("High Speed Downloads", style: TextStyle(color: Colors.white, fontSize:12)),
              value: highSpeed,
              onChanged: (v) async {
                final p=await SharedPreferences.getInstance();
                await p.setBool('high_speed',v);
                setState(()=>highSpeed=v);
              }
            )
          ),
          LiquidGlass(
            child: SwitchListTile(
              title: Text("Allow All Permissions", style: TextStyle(color: Colors.white, fontSize:12)),
              value: allowPermissions,
              onChanged: (v) async {
                final p=await SharedPreferences.getInstance();
                await p.setBool('allow_permissions',v);
                setState(()=>allowPermissions=v);
              }
            )
          ),
          LiquidGlass(
            child: SwitchListTile(
              title: Text("Dark Mode / Light Mode", style: TextStyle(color: Colors.white, fontSize:12)),
              value: darkMode,
              onChanged: (v) async {
                final p=await SharedPreferences.getInstance();
          ...
          SizedBox(height:8),
          Text("Security", style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)),
          LiquidGlass(
            child: ListTile(
              leading: Icon(Icons.lock,color:Colors.white70),
              title: Text(
                "Set Passcode 6-digits: ${passcode.isEmpty? "Not set" : "****${passcode.substring(passcode.length>2?passcode.length-2:0)}"}",
                style: TextStyle(color: Colors.white, fontSize:12)
              ),
              onTap: setPasscodeDialog
            )
          ),
          LiquidGlass(
            child: ListTile(
              leading: Icon(Icons.fingerprint,color:Colors.white70),
              title: Text("Biometric", style: TextStyle(color: Colors.white)),
              onTap: () async {
                final auth=LocalAuthentication();
                if(await auth.canCheckBiometrics){
                  final did=await auth.authenticate(localizedReason:"Biometric");
                  if(did&&mounted){
                    ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text("Biometric OK")));
                  }
                }
              }
            )
          ...
          LiquidGlass(
            child: ListTile(
              leading: Icon(Icons.face,color:Colors.white70),
              title: Text("Face ID", style: TextStyle(color: Colors.white)),
              onTap: () async {
                final auth=LocalAuthentication();
                if(await auth.canCheckBiometrics){
                  final did=await auth.authenticate(localizedReason:"Face ID");
                  if(did&&mounted){
                    ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text("Face ID OK")));
                  }
                }
              }
            )
          ...
          LiquidGlass(
            child: ListTile(
              ...
              title: Text("Password Security", style: TextStyle(color: Colors.white)),
              onTap: (){
                ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text("Password: ${widget.email}")));
              }
            )
          ),
          SizedBox(height:8),
          ...
          LiquidGlass(
            child: ListTile(
              ...
              onTap: () async {
                final uri=Uri.parse("https://play.google.com/store/apps/details?id=com.onyx.movies");
                if(await canLaunchUrl(uri)){
                  await launchUrl(uri);
                }
              }
          ...
          LiquidGlass(
            child: ListTile(
              ...
              onTap: () async {
                await Share.share(
                  "Download ONYX MOVIES - Best VJ Movies App https://github.com/bluezzer/onyx-movie-final/releases"
                );
              }
            )
          ),
            ...
            child: Column(
              children:[
                ListTile(
                  ...
                  title: Text("mugabibenjamin14@gmail.com", style: TextStyle(color: Colors.white, fontSize:12)),
                  onTap: () async {
                    final uri=Uri.parse("mailto:mugabibenjamin14@gmail.com");
                    if(await canLaunchUrl(uri)){
                      await launchUrl(uri);
                    }
                  }
                ...
                ListTile(
                  ...
                  title: Text("Instagram: onyxmovies", style: TextStyle(color: Colors.white, fontSize:12)),
                  onTap: () async {
                    final uri=Uri.parse("https://instagram.com/onyxmovies");
                    if(await canLaunchUrl(uri)){
                      await launchUrl(uri, mode: LaunchMode.externalApplication);
                    }
                  }
                ...
                ListTile(
                  leading: Icon(Icons.facebook,color:Colors.white70),
                  title: Text("Facebook: onyx movies14", style: TextStyle(color: Colors.white, fontSize:12)),
                  onTap: () async {
                ...
                ListTile(
                  ...
                  title: Text("X / Twitter: onyxmovies", style: TextStyle(color: Colors.white, fontSize:12)),
                  onTap: () async {
                    final uri=Uri.parse("https://twitter.com/onyxmovies");
                    if(await canLaunchUrl(uri)){
                      await launchUrl(uri, mode: LaunchMode.externalApplication);
                    }
                  }
...
class AdminMainNavState extends State<AdminMainNav>{
  ...
  Widget build(BuildContext context){
    final pages=[
      AdminDashboardTab(email:widget.email),
      AdminAddMovie(),
      AdminManageMovies()
    ];
    return Scaffold(
        ...
        LiquidGlass(
          ...
          child: SizedBox(
            ...
            child: ElevatedButton(
              ...
              child: Text(
                "Add Movie + Category + VJ + Genre + Year + Trending",
                style: TextStyle(color: Colors.white)
              )
            )
          )
            ...
            return Padding(
              ...
              child: LiquidGlass(
                child: ListTile(
                  ...
                  subtitle: Text(
                    "$cat • $vj • ${m['year']??''} ${m['isTrending']==true? "• TRENDING":""}",
                    style: TextStyle(color: Colors.white54, fontSize:10)
                  ),
                  trailing: IconButton(
...
class AdminAddMovie extends StatefulWidget{
  ...
  @override State<AdminAddMovie> createState()=>AdminAddMovieState();
}
...
class AdminAddMovieState extends State<AdminAddMovie>{
  ...
  void pickPoster() async {
    final x=await picker.pickImage(source:ImageSource.gallery);
    if(x!=null){
      final b=await x.readAsBytes();
      setState(()=>posterBytes=b);
    }
  }
  void pickBanner() async {
    ...
    if(x!=null){
      final b=await x.readAsBytes();
      setState(()=>bannerBytes=b);
    }
  }
  void addCast() async {
    if(casts.length>=5){
      ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text("Max 5 casts")));
      return;
    }
      ...
      builder: (_) {
        return StatefulBuilder(
          builder: (c,setS){
            return AlertDialog(
              backgroundColor: Color(0xFF1E293B),
              title: Text("Add Cast", style: TextStyle(color: Colors.white)),
              content: Column(
                mainAxisSize: MainAxisSize.min,
                children:[
                  GestureDetector(
                    ...
                    child: CircleAvatar(
                      radius:30,
                      backgroundImage: castImg!=null?MemoryImage(castImg!):null,
                      child: castImg==null?Icon(Icons.person):null
                    )
                  ),
                  TextField(
                    controller: realC,
                  ...
                  TextField(
                    controller: actedC,
                    style: TextStyle(color: Colors.white),
                    decoration: InputDecoration(labelText:"Acted Name")
                  )
                ]
              ),
              actions:[
                  ...
                  onPressed: (){
                    setState((){
                      casts.add(
                        {
                          "realName":realC.text,
                          "actedName":actedC.text,
                          "imageBase64":castImg!=null?base64Encode(castImg!):""
                        }
                      );
                    });
                    Navigator.pop(context);
  ...
  void save() async {
    ...
    if(bannerBytes!=null){
      ...
      await bRef.set(
        {
          "imageBase64":base64Encode(bannerBytes!),
    ...
    if(mounted){
      ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text("Saved! Linked to User Panel")));
      Navigator.pop(context);
    }
  }
  @override
  Widget build(BuildContext context){
    return Scaffold(
      backgroundColor: Color(0xFF020617),
      appBar: AppBar(backgroundColor: Color(0xFF020617), title: Text("ADMIN: Add Movie/Series")),
      body: SingleChildScrollView(
        padding: EdgeInsets.all(12),
        child: Column(
          children: [
            LiquidGlass(
              child: Padding(
                ...
                child: TextField(
                  controller:titleC,
                  style:TextStyle(color:Colors.white),
                  decoration:InputDecoration(labelText:"Movie Title *", border:InputBorder.none)
                )
              )
            ),
            SizedBox(height:8),
              ...
              child: Padding(
                ...
                child: TextField(
                  ...
                  decoration:InputDecoration(
                    labelText:"VJ Name (shows on poster corner upright)",
            ...
            LiquidGlass(
              child: Padding(
                ...
                child: TextField(
                  ...
                  style:TextStyle(color:Colors.white),
                  decoration:InputDecoration(
                    labelText:"Genre (Action, Indian, Animation...)",
                    border:InputBorder.none
                  )
                )
              )
            ...
            LiquidGlass(
              child: Padding(
                ...
                child: TextField(
                  controller:yearC,
                  style:TextStyle(color:Colors.white),
                  decoration:InputDecoration(labelText:"Year of Release (2024)", border:InputBorder.none)
                )
              )
            ),
            SizedBox(height:12),
              ...
              child: Padding(
                ...
                child: Column(
                  children: [
                      ...
                      children:[
                        ...
                        DropdownButton<String>(
                          ...
                          items: [
                            ...
                            DropdownMenuItem(value:"Indian", child: Text("Indian Movie")),
                    ...
                    SwitchListTile(
                      title: Text(
                        "Is Trending? - Shows in Trending section",
                        style: TextStyle(color: Colors.white, fontSize:12)
                      ),
                      value: isTrending,
                      onChanged: (v){
                ...
                Expanded(
                  child: LiquidGlass(
                    child: ElevatedButton.icon(
                      onPressed: pickPoster,
                      icon: Icon(Icons.image,color:Colors.white70),
                      label: Text(
                        posterBytes==null?"Pick Poster":"Poster OK",
                ...
                Expanded(
                  child: LiquidGlass(
                    child: ElevatedButton.icon(
                      ...
                      icon: Icon(Icons.panorama,color:Colors.white70),
                      label: Text(
                        bannerBytes==null?"Pick Banner (7 Latest)":"Banner OK",
                        style: TextStyle(color: Colors.white70)
                      )
                    )
                  )
            ...
            LiquidGlass(
              child: Padding(
                ...
                child: Row(
                  children:[
                    Text("Casts (max 5) - Shows in Player", style: TextStyle(color: Colors.white)),
                    Spacer(),
                    ElevatedButton(
                      onPressed: addCast,
                      child: Text("Add Cast")
            ...
            Wrap(
              ...
              children: casts.map((c){
                return Chip(label: Text(c['realName']));
              }).toList()
            ),
            SizedBox(height:20),
            LiquidGlass(
              ...
              child: SizedBox(
                ...
                child: ElevatedButton(
                  ...
                  style: ElevatedButton.styleFrom(backgroundColor: Colors.white.withOpacity(0.1)),
                  child: Text(
                    "Save to Firebase - Links to User Panel",
                    style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)
                  )
                )
              )
