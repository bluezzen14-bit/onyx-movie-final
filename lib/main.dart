...
class IPhoneLoader extends StatelessWidget {
  ...
  @override Widget build(BuildContext context){
    return Center(
      child: Column(
        ...
        children: [
          Container(width: 24, height: 24, decoration: BoxDecoration(color: Colors.white.withOpacity(0.06), shape: BoxShape.circle, border: Border.all(color: Colors.white.withOpacity(0.15))), child: Icon(Icons.apple, color: Colors.white70, size: 14)),
          SizedBox(height: 6),
          SizedBox(width: 14, height: 14, child: CircularProgressIndicator(strokeWidth: 1.5, color: Colors.white60)),
        ],
      ),
    );
  }
...
class AdminAddMovieState extends State<AdminAddMovie>{
  ...
  @override Widget build(BuildContext context){
    return Scaffold(
      ...
      appBar: AppBar(backgroundColor: Color(0xFF020617), title:Text("ADMIN PRO: Add Movie - Transparent iOS 26")),
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
                ...
                child: Row(
                  children: [
                    ...
                    DropdownButton<String>(
                      ...
                      items: ["Movie","Series"].map((e) => DropdownMenuItem(value: e, child: Text(e))).toList(),
            ...
            SizedBox(height:12),
            Row(children:[Expanded(child:LiquidGlass(child: ElevatedButton.icon(onPressed:pickPoster, style:ElevatedButton.styleFrom(backgroundColor:Colors.transparent, shadowColor:Colors.transparent), icon:Icon(Icons.image,color:Colors.white70),label:Text(posterBytes==null?"Pick Poster":"Poster OK", style:TextStyle(color:Colors.white70))))),SizedBox(width:8),Expanded(child:LiquidGlass(child: ElevatedButton.icon(onPressed:pickBanner, style:ElevatedButton.styleFrom(backgroundColor:Colors.transparent, shadowColor:Colors.transparent), icon:Icon(Icons.panorama,color:Colors.white70),label:Text(bannerBytes==null?"Pick Banner 1":"Banner OK", style:TextStyle(color:Colors.white70)))))]),
            SizedBox(height:12),
            LiquidGlass(child: Padding(padding:EdgeInsets.all(8), child: Row(children:[Text("Casts (max 5)", style:TextStyle(color:Colors.white)),Spacer(),ElevatedButton(onPressed:addCast,child:Text("Add Cast"))]))),
            Wrap(spacing:8,children:casts.map((c)=>Chip(label:Text(c['realName']))).toList()),
            SizedBox(height:20),
            LiquidGlass(radius:12, child: SizedBox(width:double.infinity,height:50,child:ElevatedButton(onPressed:save,style:ElevatedButton.styleFrom(backgroundColor:Colors.white.withOpacity(0.1)),child:Text("Save to Firebase - Transparent PRO",style:TextStyle(color:Colors.white,fontWeight:FontWeight.bold))))),
          ],
        ),
      ),
    );
